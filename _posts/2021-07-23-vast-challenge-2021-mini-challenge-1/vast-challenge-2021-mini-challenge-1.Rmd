...
<aside>
The visNetwork package was used for the interactive visNetwork diagram. There is a manipulation function that allows us to push the nodes further apart so that they do not look so cluttered and obscure readers' readability. 
</aside>
...
*GAStech employee's personal relationship with the government (military)*
